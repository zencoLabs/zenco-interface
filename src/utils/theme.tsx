...
const FONT = 'Favorit, Helvetica Neue,Arial,sans-serif';
...
export const getDesignTokens = (mode: 'light' | 'dark') => {
  ...
  return {
    ...
    palette: {
      ...
      text: {
        primary: getColor('#121212', '#F9FFFE'),
        secondary: getColor('#62677B', '#b3bac2'),
        disabled: getColor('#D2D4DC', '#62677B'),
        muted: getColor('#A5A8B6', '#8E92A3'),
        offbeat1: getColor('#82E7BE', '#82E7BE'),
        highlight: getColor('#121212', '#121212'), 
      },
      background: {
        main: getColor(
          'radial-gradient( 73% 51% at 50% 0%, rgba(139, 254, 253, 0.3) 0%, rgba(255,255,255,0.3) 100%, rgba(18,18,18,0) 100%)',
          'radial-gradient( 51% 51% at 50% 0%, rgba(139, 254, 253, 0.3) 0%, rgba(18,18,18,0) 100%, rgba(18,18,18,0) 100%)'),
        default: getColor('#F9FFFE;', '#26244b'),
        paper: getColor('#FFFFFF', '#ffffff'),
        surface: getColor('#F9FFFE', '#383D51'),
        surface1: getColor('#61FE7A', '#61FE7A'),
        surface2: getColor('#244D41', '#244D41'),
        surface_s: getColor('rgba(216, 216, 216, 0.6)', '#16352C'),
        surface_green:getColor('rgba(36, 77, 65, 1)', 'rgba(97, 254, 122, 1)'),
        header: getColor('rgb(50, 14, 88)', 'rgb(13, 17, 28)'),
        disabled: getColor('#EAEBEF', '#EBEBEF14'),
        colorlight: getColor('linear-gradient(14deg, #eee271 0%, #FF980C 100%)', 'linear-gradient(135.00000000000003deg, #FFF69F 0%, #FF980C 100%)'),
      },
      divider: getColor('#EAEBEF', 'rgba(151, 151, 151, 0.2)'),
      action: {
      ...
      gradients: {
        brightGradient: getColor('#61FE7A', '#61FE7A'),
        newGradient: '#244D41',
        b2Gradient:getColor('linear-gradient(to right, #a1c4fd, #c2e9fb)', 'linear-gradient(to right, #a1c4fd, #c2e9fb)'),
      },
    },
    spacing: 4,
    typography: {
        ...
        variants: [
          {
            ...
            style: {
              ...
              border: '0',
              // borderColor: '#DBFFF4',
              background: '#75cedb',//theme.palette.background.default, //'rgb(101, 38, 168)',
          ...
          {
            props: { variant: 'surface_1' },
            style: {
              color: theme.palette.common.white,
              border: '1px solid',
              borderColor: '#444270',
              backgroundColor: '#444270',
              '&:hover, &.Mui-focusVisible': {
                backgroundColor: 'rgba(68, 66, 120, 0.6)' //theme.palette.background.header,
              },
            },
          },
          {
            props: { variant: 'surface_2' },
            style: {
              color: theme.palette.common.white,
              border: '1px solid',
              borderColor: '#244D41',
              backgroundColor: '#244D41',
              '&:hover, &.Mui-focusVisible': {
                backgroundColor: 'rgba(36, 77, 65, 0.6)' //theme.palette.background.header,
              },
            },
          },
          {
            ...
            style: {
              color: theme.palette.common.white,
              background: theme.palette.gradients.brightGradient,
          ...
          },
          {
            ...
            style: {
             color: theme.palette.primary.main,
              ...
              borderRadius:4,
              '&:hover, &.Mui-focusVisible': {
                // backgroundColor: theme.palette.background.surface_s,
                border: '1px solid #646b78', 
              },
            },
          },
          {
            props: { color: 'primary', variant: 'outlined_2' },
            style: {
              color: '#75cedb',
