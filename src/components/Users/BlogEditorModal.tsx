...
export const BlogEditorModal = () => { 
    ...
    return (<>
        {
            activeStep == 0 && (
                <BasicModal open={type === ModalType.BlogEditor} setOpen={closeDailog} contentMaxWidth={720}>
                    <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                        <TxModalTitle title="Create" />
        ...
        {
            activeStep == 1 && (
                <BasicModal open={type === ModalType.BlogEditor} setOpen={closeDailog} contentMaxWidth={520}>
