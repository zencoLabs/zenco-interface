...
const BRAVE_ICON = 'assets/wallets/brave-icon.svg'
const INJECTED_DARK_ICON =  'assets/wallets/browser-wallet-dark.svg'
const INJECTED_LIGHT_ICON =  'assets/wallets/browser-wallet-light.svg'
const LEDGER_ICON =  'assets/wallets/ledger-icon.svg'
const METAMASK_ICON =  'assets/wallets/metamask-icon.svg'
const RABBY_ICON =  'assets/wallets/rabby-icon.svg'
const TRUST_WALLET_ICON =  'assets/wallets/trustwallet-icon.svg'
